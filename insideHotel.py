...
#-------------------------------------------------------------------------------------------------    
        ...
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='January'")
        #     janMonth=cursor.fetchone()
        #     for i in janMonth:
        #         #print(i)
        #         janCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='January'")
        #     evalJan=cursor.fetchone()
        #     for i in evalJan:
        #         evalCount=i;
        #     totalCount=janCount+evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'January')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
            
        
        # if(dbmonth=='February'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='February'")
        #     febMonth=cursor.fetchone()
        #     for i in febMonth:
        #         #print(i)
        #         febCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='February'")
        #     evalFeb=cursor.fetchone()
        #     for j in evalFeb:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=febCount + evalCount
        #     print(totalCount)
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'February')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
            
        # if(dbmonth=='March'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='March'")
        #     marMonth=cursor.fetchone()
        #     for i in marMonth:
        #         #print(i)
        #         marCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='March'")
        #     evalMar=cursor.fetchone()
        #     for j in evalMar:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=marCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'March')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='April'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='April'")
        #     aprMonth=cursor.fetchone()
        #     for i in aprMonth:
        #         #print(i)
        #         aprCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='April'")
        #     evalApr=cursor.fetchone()
        #     for j in evalApr:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=aprCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'April')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
            
        # if(dbmonth=='May'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='May'")
        #     mayMonth=cursor.fetchone()
        #     for i in mayMonth:
        #         #print(i)
        #         mayCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='May'")
        #     evalMay=cursor.fetchone()
        #     for j in evalMay:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=mayCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'May')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        ...
        # if(dbmonth=='June'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='June'")
        #     junMonth=cursor.fetchone()
        #     for i in junMonth:
        #         #print(i)
        #         junCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='June'")
        #     evalJune=cursor.fetchone()
        #     for j in evalJune:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=junCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'June')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='July'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='July'")
        #     julMonth=cursor.fetchone()
        #     for i in julMonth:
        #         #print(i)
        #         julCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='July'")
        #     evalJuly=cursor.fetchone()
        #     for j in evalJuly:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=julCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'July')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
            
        # if(dbmonth=='August'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='August'")
        #     augMonth=cursor.fetchone()
        #     for i in augMonth:
        #         #print(i)
        #         augCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='August'")
        #     evalAug=cursor.fetchone()
        #     for j in evalAug:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=augCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'August')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='September'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='September'")
        #     sepMonth=cursor.fetchone()
        #     for i in sepMonth:
        #         #print(i)
        #         sepCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='September'")
        #     evalSep=cursor.fetchone()
        #     for j in evalSep:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=sepCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'September')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='October'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='October'")
        #     octMonth=cursor.fetchone()
        #     for i in octMonth:
        #         #print(i)
        #         octCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='October'")
        #     evalOct=cursor.fetchone()
        #     for j in evalOct:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=octCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'October')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='November'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='November'")
        #     novMonth=cursor.fetchone()
        #     for i in novMonth:
        #         #print(i)
        #         novCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='November'")
        #     evalNov=cursor.fetchone()
        #     for j in evalNov:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=novCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'November')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
        
        # if(dbmonth=='December'):
        #     cursor.execute("SELECT count(name) FROM cost WHERE bookingMonth='December'")
        #     decMonth=cursor.fetchone()
        #     for i in decMonth:
        #         #print(i)
        #         decCount=i;
        #     #print(mayCount)
        #     cursor.execute("SELECT TotalCustomers FROM evaluate WHERE Month='December'")
        #     evalDec=cursor.fetchone()
        #     for j in evalDec:
        #         evalCount=j;
        #     print(evalCount)
        #     totalCount=decCount + evalCount
        #     sql3=("UPDATE evaluate SET TotalCustomers=%s WHERE Month=%s ")
        #     val3=(totalCount,'December')
        #     cursor.execute(sql3,val3)
        #     mycon.commit()
    ...
    #-------------------MACHINE LEARNING-----------------------------------MACHINE LEARNING----------------
        ...
        # sqlEngine= create_engine('mysql+pymysql://root:atharva2000@localhost/hotel3', pool_recycle=3600)
        # dbConnection= sqlEngine.connect()
        # dataset= pd.read_sql("select * from evaluate", dbConnection);
    
        # pd.set_option('display.expand_frame_repr', False)
        
        # print(dataset)
        # X = dataset.iloc[:, 1:-1].values #monthNo
        # y = dataset.iloc[:, 0:1].values #nof customers
        # # print(X)
        # # print(y)
        ...
        # plt.title('Months vs Customers (Training set)')
        # plt.xlabel('Months')
        ...
        # plt.plot(X_train, regressor.predict(X_train), color = 'blue')
        # plt.title('Months vs Customers (Test set)')
        # plt.xlabel('Months')
        # plt.ylabel('Customers')
        # plt.show()
